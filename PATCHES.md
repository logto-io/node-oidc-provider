...
- **Files touched**: `lib/helpers/client_id_metadata_document.js`, `lib/helpers/defaults.js`, `docs/README.md` (generated from the `defaults.js` JSDoc); tests in `test/cimd_metadata_transform/`.
